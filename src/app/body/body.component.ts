...
class AndroidClientApp {
	public onClickCameraButton(): void { console.log('onClickCameraButton()'); }
	public onClickGalleryButton(): void { console.log('onClickGalleryButton()'); }
	public onClickFeedbackButton(): void { console.log('onClickFeedbackButton()'); }
...
export class BodyComponent {
	...
	constructor(private readonly _router: Router) {
		...
		window.setBarcode = (barcode: string): void => this.searchId.setValue(barcode);
	}
